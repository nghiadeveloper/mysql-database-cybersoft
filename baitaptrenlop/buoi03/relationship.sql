...
-- Trường hợp sử dụng: Dành cho việc lưu trữ thông tin chi tiết của đối một tượng nào đó

-- one to many (1 - n): 1 dòng dữ liệu của bảng này sẽ lấy được nhiều dòng dữ liệu của bảng kia
-- Khóa ngoại nằm ở bảng nhiều
...
-- OneToMany (1 - n)
-- Bước làm như sau: Thử đặt khóa ngoại ở 1 bảng trước, nếu mà khóa ngoại đó bị trùng nhiều thì bảng đó chính là bảng nhiều, và bảng còn lại là bảng 1

-- Phân tích CSDL
-- Bước 1: Đi qua từng màn hình -> Tìm đối tượng
-- Bước 2: Tìm thuộc tính của đối tượng
-- Bước 3: Nếu trong 1 màn hình mà tìm nhiều hơn 1 đối tượng thì chắc chắn các
-- đối tượng trong màn hình đó sẽ có quan hệ với nhau